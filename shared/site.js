...
const THEME_DEFAULT = Object.assign({}, PRESETS['Editorial']);
const COLOR_ROWS = [
  { key:'bg',     label:'Paper' },
...
const DISPLAY_FONTS = [
  { n:'Newsreader', w:'400;500;600' }, { n:'System', w:'' }, { n:'Bricolage Grotesque', w:'400;500;700;800' }, { n:'Space Grotesk', w:'400;500;700' },
  { n:'Syne', w:'400;700;800' }, { n:'Unbounded', w:'400;700;900' },
  { n:'Archivo Black', w:'400' }, { n:'Fraunces', w:'400;600;800' },
];
const BODY_FONTS = [
  { n:'Source Sans 3', w:'400;600' }, { n:'System', w:'' }, { n:'Space Grotesk', w:'400;500;700' }, { n:'Inter', w:'400;500;700' },
  { n:'DM Sans', w:'400;500;700' }, { n:'Work Sans', w:'400;500;600' },
];
const _loadedFonts = new Set(['Newsreader','Source Sans 3']);
...
const SERIF_FONTS = new Set(['Newsreader','Fraunces']);
function fontStack(name){
  if (name === 'System') return SYSTEM_STACK;
